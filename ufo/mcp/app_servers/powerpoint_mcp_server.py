...
Provides MCP interface for Microsoft PowerPoint automation via UFO framework.
"""
...
def main():
    ...
    print("=" * 50)
    print("UFO PowerPoint MCP Server")
    print("Microsoft PowerPoint automation via Model Context Protocol")
    print(f"Running on {args.host}:{args.port}")
    print("=" * 50)
    
    # Create and run the PowerPoint MCP server
    server = create_mcp_server(
        app_namespace="powerpoint",
        server_name="ufo-powerpoint",
