...
class CoreMCPClient(MCPClient):
    ...
    def _capture_desktop_screenshot(self, action: CaptureDesktopScreenshotAction) -> str:
        """Execute capture_desktop_screenshot MCP tool."""
        params = action.params or {}
        arguments = {
            "all_screens": getattr(params, "all_screens", True)
        }
        return self._make_tool_call("capture_desktop_screenshot", arguments)
    
    def _capture_app_window_screenshot(self, action: CaptureAppWindowScreenshotAction) -> str:
    ...
    def _get_desktop_app_info(self, action: GetDesktopAppInfoAction) -> List[Dict[str, Any]]:
    ...
    def _get_app_window_control_info(self, action: GetAppWindowControlInfoAction) -> Dict[str, Any]:
    ...
    def _select_application_window(self, action: SelectApplicationWindowAction) -> Dict[str, Any]:
        """Execute select_application_window MCP tool."""
        params = action.params or {}
        arguments = {
            "window_label": getattr(params, "window_label", "")
        }
    ...
    def _launch_application(self, action: LaunchApplicationAction) -> Dict[str, Any]:
        ...
        params = action.params or {}
        arguments = {
            "bash_command": getattr(params, "bash_command", "")
        }
        return self._make_tool_call("launch_application", arguments)
    
    def _find_control_elements(self, action: FindControlElementsAction) -> Dict[str, Any]:
    ...
    def _execute_operation_sequence(self, action: OperationSequenceAction) -> Dict[str, Any]:
    ...
    def _handle_mcp_tool_execution(self, action: MCPToolExecutionAction) -> Dict[str, Any]:
            ...
            return {
                "tools": [
                    ...
                    },
                    {
                        ...
                        "parameters": ["annotation_id", "control_type_list", "class_name_list"]
                    },
                    {
                        "name": "get_ui_tree",
                    ...
                    },
                    {
                        ...
                        "parameters": ["control_label", "control_text", "button", "double"]
                    },
                    {
                        "name": "set_edit_text",
