...
class Round(BaseRound):
    ...
    def process_application_selection(self) -> None:
        ...
        host_agent_processor = self._create_host_agent_processor(processor.HostAgentProcessor)
    ...
    def process_action_selection(self) -> None:
        ...
        app_agent_processor = self._create_app_agent_processor(processor.AppAgentProcessor)
        self._run_step(app_agent_processor)

        self.control_reannotate = app_agent_processor.get_control_reannotate()


    def _create_host_agent_processor(self, processor_class: Type['processor.BaseProcessor']) -> processor.HostAgentProcessor:

        return processor_class(round_num=self.round_num, log_path=self.log_path, request=self.request, round_step=self.get_step(), session_step=self.session_step,
    ...
    def _create_app_agent_processor(self, processor_class: Type['processor.BaseProcessor']) -> processor.AppAgentProcessor:
...
class FollowerRound(Round):
    ...
    def process_application_selection(self) -> None:
        ...
        host_agent_processor = self._create_host_agent_processor(follower_processor.FollowerHostAgentProcessor)
    ...
    def process_action_selection(self) -> None:
        ...
        app_agent_processor = self._create_app_agent_processor(follower_processor.FollowerAppAgentProcessor)
        self._run_step(app_agent_processor)

        self.control_reannotate = app_agent_processor.get_control_reannotate()


    def _create_app_agent_processor(self, processor_class: Type['processor.BaseProcessor']) -> follower_processor.AppAgentProcessor:
        """
