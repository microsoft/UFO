...
class BatchAppAgentProcessor(AppAgentProcessor):
    """
    The processor for the AppAgent in the batch mode.
    """

    def __init__(self, agent: "BatchAgent", context: Context) -> None:
        """
        Initialize the BatchAppAgentProcessor.
    ...
    def get_prompt_message(self) -> None:
        """
        Get the prompt message for the AppAgent in the batch mode. It may accept additional prompts as input.
        """
