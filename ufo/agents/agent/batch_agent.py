...
from ufo.agents.processors.batch_agent_processor import BatchAppAgentProcessor
from ufo.module.context import Context
from ufo.prompter.agent_prompter import BatchAgentPrompter


class BatchAgent(AppAgent):
    """
    The BatchAgent class the manager of a FollowedAgent that follows the step-by-step instructions for action execution within an application.
    ...
    def get_prompter(
        ...
        """
        Get the prompter for the batch agent.
        :param is_visual: The flag indicating whether the agent is visual or not.
        :param main_prompt: The main prompt file path.
        :param example_prompt: The example prompt file path.
        :param api_prompt: The API prompt file path.
    ...
    def process(self, context: Context) -> None:
        ...
        self.processor = BatchAppAgentProcessor(agent=self, context=context)
