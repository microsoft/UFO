...
from galaxy.constellation.enums import TaskPriority, DeviceType
...
#### Usage Example
```python
from galaxy.constellation import TaskStar, TaskPriority, DeviceType
...
**Basic Dependencies**
```python
from galaxy.constellation import TaskStarLine, DependencyType
...
from galaxy.constellation import TaskConstellation, TaskStar, TaskPriority
...
### Event Integration
```python
from galaxy.core.events import get_event_bus, ConstellationEvent, TaskEvent
