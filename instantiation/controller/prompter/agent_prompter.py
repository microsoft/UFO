...
class ExecutePrompter(BasicPrompter):
    ...
    def user_content_construction(
        ...
        if self.is_visual:
            screenshot = self.load_screenshots(log_path)
            screenshot_text = """You are a action execute agent, responsible to execute the given task.
                                This is the screenshot of the current environment, please check it and execute task accodingly."""
