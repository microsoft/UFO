...
!!!info "What's New in UFO²"
    The configuration system has been completely redesigned in UFO² 2.0.0 with modular YAML files, type safety, and automatic discovery. If you're upgrading from UFO v1.x, see the [Migration Guide](./migration.md).

## Design Philosophy

The new configuration system follows professional software engineering best practices:
...
**Example - Hybrid Configuration Access**:
...
!!!success "Zero Breaking Changes"
    Your existing code will continue to work without any modifications. The system automatically falls back to legacy paths and access patterns.
...
Configuration files are merged recursively:
...
**Advantages**:
- Agent-specific settings isolated
...
For custom or experimental settings:
...
**Example - Hybrid Configuration Model**:
...
:::config_schemas.UFOConfig

:::config_schemas.GalaxyConfig
