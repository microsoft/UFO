...
Before using the hybrid control detection, you need to deploy and configure the OmniParser model. You can refer to the [OmniParser deployment](./visual.md) for more details.
