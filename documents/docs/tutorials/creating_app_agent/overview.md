...
| --- | --- | --- |
| [Help Documents](./help_document_provision.md) | The help documents for the application to guide the `AppAgent` in executing tasks. | [Learning from Help Documents](../../ufo2/core_features/knowledge_substrate/learning_from_help_document.md) |
| [User Demonstrations](./demonstration_provision.md) | The user demonstrations for the application to guide the `AppAgent` in executing tasks. | [Learning from User Demonstrations](../../ufo2/core_features/knowledge_substrate/learning_from_demonstration.md) |
