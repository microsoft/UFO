...
After creating the offline indexer, you can find the guidance on how to use the help documents to enhance the `AppAgent` in the [Learning from Help Documents](../../ufo2/advanced_usage/knowledge_substrate/learning_from_help_document.md) section.