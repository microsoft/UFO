...
After creating the offline indexer, refer to the [Learning from User Demonstrations](../../ufo2/advanced_usage/knowledge_substrate/learning_from_demonstration.md) section for guidance on how to use human demonstrations to enhance the AppAgent.
