...
## For Users
If you are a user of UFO, and want to use it to automate your tasks on Windows, you can refer to [Configuration Field Reference](../configurations/field_reference.md) to set up your environment and start using UFO.
...
## For Developers
If you are a developer who wants to contribute to UFO, you can take a look at the [Configuration Overview](../configurations/overview.md) and [Field Reference](../configurations/field_reference.md) to explore the development environment setup and the development workflow.
